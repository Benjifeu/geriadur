...
public class SessionGameService implements ISessionGameService {
     ...
     * (EtymonName) and 5 choices of responses (litteral translations)
     */
    ...
    /**
     * get15EtymonName() returns a random list of 15 EtymonName from the DB
     ...
     * translation for a specific EtymonName, the one in the arguments is the good
     * response which is
     */
